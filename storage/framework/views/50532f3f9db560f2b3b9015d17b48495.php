...
<?php $__env->startSection('title', 'المعرض البصري | نظم الوسائط المتعددة'); ?>
            ...
            <div class="gallery-section reveal">
                ...
                <div class="grid-featured">
                    ...
                    <div class="gi gi-1" onclick="openLb('lb1')">
                        <img src="<?php echo e(asset('images/gallery/futuristic_city.jpg')); ?>" alt="مدينة مستقبلية" style="width:100%; height:100%; object-fit:cover; position:absolute; top:0; left:0;">
                    ...
                    <div class="gi gi-2" onclick="openLb('lb2')">
                        <img src="<?php echo e(asset('images/gallery/glass_tower.jpg')); ?>" alt="برج زجاجي" style="width:100%; height:100%; object-fit:cover; position:absolute; top:0; left:0;">
                    ...
                    <div class="gi gi-3" onclick="openLb('lb3')">
                        <img src="<?php echo e(asset('images/gallery/rainy_street.jpg')); ?>" alt="شارع مطري" style="width:100%; height:100%; object-fit:cover; position:absolute; top:0; left:0;">
                    ...
                    <div class="gi gi-4" onclick="openLb('lb4')">
                        <img src="<?php echo e(asset('images/gallery/floating_garden.jpg')); ?>" alt="حديقة عائمة" style="width:100%; height:100%; object-fit:cover; position:absolute; top:0; left:0;">
                    ...
                    <div class="gi gi-5" onclick="openLb('lb5')">
                        <img src="<?php echo e(asset('images/gallery/space_port.jpg')); ?>" alt="ميناء فضائي" style="width:100%; height:100%; object-fit:cover; position:absolute; top:0; left:0;">
            ...
            <div class="gallery-section reveal" style="transition-delay:.1s">
                ...
                <div class="grid-regular">
                    <div class="gi-r" onclick="openLb('lbp1')">
                        <img src="<?php echo e(asset('images/gallery/portrait1.jpg')); ?>" alt="بورتريه 1" style="width:100%; height:100%; object-fit:cover; position:absolute; top:0; left:0;">
                    ...
                    <div class="gi-r" onclick="openLb('lbp2')">
                        <img src="<?php echo e(asset('images/gallery/portrait2.jpg')); ?>" alt="بورتريه 2" style="width:100%; height:100%; object-fit:cover; position:absolute; top:0; left:0;">
                    ...
                    <div class="gi-r" onclick="openLb('lbp3')">
                        <img src="<?php echo e(asset('images/gallery/fantasy_char.jpg')); ?>" alt="شخصية خيالية" style="width:100%; height:100%; object-fit:cover; position:absolute; top:0; left:0;">
                    ...
                    <div class="gi-r" onclick="openLb('lbp4')">
                        <img src="<?php echo e(asset('images/gallery/abstract.jpg')); ?>" alt="لوحة تجريدية" style="width:100%; height:100%; object-fit:cover; position:absolute; top:0; left:0;">
                    ...
                    <div class="gi-r" onclick="openLb('lbp5')">
                        <img src="<?php echo e(asset('images/gallery/future_fashion.jpg')); ?>" alt="موضة مستقبلية" style="width:100%; height:100%; object-fit:cover; position:absolute; top:0; left:0;">
                    ...
                    <div class="gi-r" onclick="openLb('lbp6')">
                        <img src="<?php echo e(asset('images/gallery/typography.jpg')); ?>" alt="تصميم طباعي" style="width:100%; height:100%; object-fit:cover; position:absolute; top:0; left:0;">
                    ...
                    <div class="gi-r" onclick="openLb('lbp7')">
                        <img src="<?php echo e(asset('images/gallery/fantasy_nature.jpg')); ?>" alt="طبيعة خيالية" style="width:100%; height:100%; object-fit:cover; position:absolute; top:0; left:0;">
                        <div class="img-badge pink">DALL·E 3</div>
                    ...
                    <div class="gi-r" onclick="openLb('lbp8')">
                        <img src="<?php echo e(asset('images/gallery/interior.jpg')); ?>" alt="معمار داخلي" style="width:100%; height:100%; object-fit:cover; position:absolute; top:0; left:0;">
                        <div class="img-badge">Stable Diffusion</div>
            ...
            <div class="gallery-section reveal" style="transition-delay:.2s">
                ...
                <div class="grid-regular" style="grid-template-columns:repeat(5,1fr);">
                    <div class="gi-r" style="min-height:160px;" onclick="openLb('lb-comp1')">
                        <img src="<?php echo e(asset('images/gallery/comp_midjourney.jpg')); ?>" alt="Midjourney comparison" style="width:100%; height:100%; object-fit:cover; position:absolute;">
                        <div class="img-badge" style="font-size:.65rem;">Midjourney</div>
                    </div>
                    <div class="gi-r" style="min-height:160px;" onclick="openLb('lb-comp2')">
                        <img src="<?php echo e(asset('images/gallery/comp_dalle.jpg')); ?>" alt="DALL·E comparison" style="width:100%; height:100%; object-fit:cover; position:absolute;">
                    ...
                    <div class="gi-r" style="min-height:160px;" onclick="openLb('lb-comp3')">
                        <img src="<?php echo e(asset('images/gallery/comp_sd.jpg')); ?>" alt="Stable Diffusion comparison" style="width:100%; height:100%; object-fit:cover; position:absolute;">
                    ...
                    <div class="gi-r" style="min-height:160px;" onclick="openLb('lb-comp4')">
                        <img src="<?php echo e(asset('images/gallery/comp_firefly.jpg')); ?>" alt="Firefly comparison" style="width:100%; height:100%; object-fit:cover; position:absolute;">
                        <div class="img-badge gold" style="font-size:.65rem;">Firefly</div>
                    </div>
                    <div class="gi-r" style="min-height:160px;" onclick="openLb('lb-comp5')">
                        <img src="<?php echo e(asset('images/gallery/comp_ideogram.jpg')); ?>" alt="Ideogram comparison" style="width:100%; height:100%; object-fit:cover; position:absolute;">
...
<script>
    ...
    const lbData = {
        // Featured section
        lb1: { tool: 'Midjourney v6', title: 'مدينة سايبربانك ليلية', desc: 'مشهد ليلي لمدينة مستقبلية بإضاءة نيون — مُولَّد ومُعالج بصيغة WEBP عالية الجودة', size: '2048×2048', fmt: 'WEBP', prompt: 'Futuristic cyberpunk city at night, neon blue and red lighting, aerial view, rain reflections, ultra detailed, 4K --ar 16:9 --v 6', img: '<?php echo e(asset("images/gallery/futuristic_city.jpg")); ?>' },
        lb2: { tool: 'DALL·E 3', title: 'ناطحة سحاب زجاجية', desc: 'برج زجاجي ذو تصميم عضوي ملتوٍ — مُولَّد بـ DALL·E 3 ضمن ChatGPT', size: '1792×1792', fmt: 'WEBP', prompt: 'Futuristic glass skyscraper with organic twisted design, surrounded by clouds, photorealistic, architectural render', img: '<?php echo e(asset("images/gallery/glass_tower.jpg")); ?>' },
        lb3: { tool: 'Stable Diffusion XL', title: 'شارع حضري في المطر', desc: 'شارع مضاء بأنوار المدينة وانعكاساتها على الأرض المبللة — مُولَّد بـ SDXL', size: '1024×1024', fmt: 'WEBP', prompt: 'Rainy city street at night, neon reflections on wet pavement, photorealistic, cinematic lighting, 8K', img: '<?php echo e(asset("images/gallery/rainy_street.jpg")); ?>' },
        lb4: { tool: 'Adobe Firefly 3', title: 'حديقة عائمة فوق المدينة', desc: 'منظر خيالي لحديقة خضراء معلقة فوق ناطحات السحاب — مُولَّد بـ Adobe Firefly', size: '2048×2048', fmt: 'WEBP', prompt: 'Floating garden above a futuristic city, lush greenery, waterfalls, golden hour lighting, photorealistic', img: '<?php echo e(asset("images/gallery/floating_garden.jpg")); ?>' },
        lb5: { tool: 'Ideogram v2', title: 'ميناء فضائي تحت الماء', desc: 'محطة فضائية تحت الماء بتصميم هندسي مذهل — مُولَّد بـ Ideogram', size: '1536×1536', fmt: 'WEBP', prompt: 'Underwater space station with bioluminescent sea creatures, deep ocean, sci-fi architecture', img: '<?php echo e(asset("images/gallery/space_port.jpg")); ?>' },
        // Portraits (simplified for brevity - add as many as needed)
        lbp1: { tool: 'Midjourney v6', title: 'بورتريه كلاسيكي', desc: 'بورتريه بأسلوب النيوكلاسيك', size: '1024×1024', fmt: 'AVIF', prompt: 'Portrait of a young woman in neoclassical style, soft lighting, detailed face', img: '<?php echo e(asset("images/gallery/portrait1.jpg")); ?>' },
        lbp2: { tool: 'DALL·E 3', title: 'بورتريه انطباعي', desc: 'بورتريه بأسلوب انطباعي', size: '1024×1024', fmt: 'AVIF', prompt: 'Impressionist portrait, colorful brushstrokes, emotional expression', img: '<?php echo e(asset("images/gallery/portrait2.jpg")); ?>' },
        lbp3: { tool: 'SDXL + LoRA', title: 'شخصية فانتازيا', desc: 'شخصية خيالية مع إضاءة سينمائية', size: '1024×1024', fmt: 'WEBP', prompt: 'Fantasy elf warrior with glowing eyes, epic lighting, detailed armor', img: '<?php echo e(asset("images/gallery/fantasy_char.jpg")); ?>' },
        lbp4: { tool: 'Adobe Firefly 3', title: 'لوحة تجريدية', desc: 'لوحة تجريدية بألوان زاهية', size: '1024×1024', fmt: 'WEBP', prompt: 'Abstract painting with vibrant colors, fluid shapes, modern art', img: '<?php echo e(asset("images/gallery/abstract.jpg")); ?>' },
        lbp5: { tool: 'Midjourney v6', title: 'أزياء مستقبلية', desc: 'تصاميم أزياء خيالية', size: '1024×1024', fmt: 'AVIF', prompt: 'Futuristic fashion design, holographic fabrics, cyberpunk style', img: '<?php echo e(asset("images/gallery/future_fashion.jpg")); ?>' },
        lbp6: { tool: 'Ideogram v2', title: 'تصميم طباعي', desc: 'بوستر مع نصوص عربية', size: '1024×1024', fmt: 'WEBP', prompt: 'Typography poster with Arabic calligraphy, modern design', img: '<?php echo e(asset("images/gallery/typography.jpg")); ?>' },
        lbp7: { tool: 'DALL·E 3', title: 'طبيعة خيالية', desc: 'غابة بألوان ساحرة', size: '1024×1024', fmt: 'AVIF', prompt: 'Enchanted forest with bioluminescent plants, dreamlike atmosphere', img: '<?php echo e(asset("images/gallery/fantasy_nature.jpg")); ?>' },
        lbp8: { tool: 'SDXL + ControlNet', title: 'معمار داخلي', desc: 'تصميم داخلي بأسلوب باوهاوس', size: '1024×1024', fmt: 'WEBP', prompt: 'Bauhaus interior design, minimalist furniture, natural light', img: '<?php echo e(asset("images/gallery/interior.jpg")); ?>' },
        // Comparisons (add similarly)
        'lb-comp1': { tool: 'Midjourney v6', title: 'عصبونات مشعة (Midjourney)', desc: 'Midjourney result for the neural network prompt', size: '1024×1024', fmt: 'WEBP', prompt: 'A glowing neural network brain made of light, floating in dark space, photorealistic, 8K', img: '<?php echo e(asset("images/gallery/comp_midjourney.jpg")); ?>' },
        'lb-comp2': { tool: 'DALL·E 3', title: 'عصبونات مشعة (DALL·E 3)', desc: 'DALL·E 3 result', size: '1024×1024', fmt: 'WEBP', prompt: 'A glowing neural network brain made of light, floating in dark space, photorealistic, 8K', img: '<?php echo e(asset("images/gallery/comp_dalle.jpg")); ?>' },
        'lb-comp3': { tool: 'Stable Diffusion XL', title: 'عصبونات مشعة (SDXL)', desc: 'Stable Diffusion result', size: '1024×1024', fmt: 'AVIF', prompt: 'A glowing neural network brain made of light, floating in dark space, photorealistic, 8K', img: '<?php echo e(asset("images/gallery/comp_sd.jpg")); ?>' },
        'lb-comp4': { tool: 'Adobe Firefly 3', title: 'عصبونات مشعة (Firefly)', desc: 'Firefly result', size: '1024×1024', fmt: 'WEBP', prompt: 'A glowing neural network brain made of light, floating in dark space, photorealistic, 8K', img: '<?php echo e(asset("images/gallery/comp_firefly.jpg")); ?>' },
        'lb-comp5': { tool: 'Ideogram v2', title: 'عصبونات مشعة (Ideogram)', desc: 'Ideogram result', size: '1024×1024', fmt: 'AVIF', prompt: 'A glowing neural network brain made of light, floating in dark space, photorealistic, 8K', img: '<?php echo e(asset("images/gallery/comp_ideogram.jpg")); ?>' }
    };
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\AdhOom\laravel\generative-ai\resources\views/gallery.blade.php ENDPATH**/ ?>