...
<?php $__env->startSection('title', 'الذكاء الاصطناعي التوليدي | نظم الوسائط المتعددة'); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <section id="hero">
    ...
    <div class="hero-cta">
      <a href="<?php echo e(url('/about')); ?>" class="btn-primary">ابدأ الاستكشاف</a>
      <a href="<?php echo e(url('/gallery')); ?>" class="btn-outline">شاهد الأمثلة</a>
    </div>

    <div class="hero-video-wrap">
      <video poster="<?php echo e(asset('images/hero-poster.jpg')); ?>" controls preload="metadata">
        <source src="<?php echo e(asset('videos/intro.mp4')); ?>" type="video/mp4">
    ...
    <div class="section-inner">
      ...
      <div class="gallery-grid reveal" style="transition-delay:.1s">
        <div class="img-card img-main">
          <img src="<?php echo e(asset('images/gallery/main.jpg')); ?>" alt="صورة رئيسية">
          <div class="img-label">AI Generated · Midjourney</div>
        </div>
        <div class="img-card img-sm">
          <img src="<?php echo e(asset('images/gallery/img2.jpg')); ?>" alt="صورة ٢">
          <div class="img-label">DALL·E 3</div>
        </div>
        <div class="img-card img-sm">
          <img src="<?php echo e(asset('images/gallery/img3.jpg')); ?>" alt="صورة ٣">
          <div class="img-label">Stable Diffusion</div>
        </div>
        <div class="img-card img-sm">
          <img src="<?php echo e(asset('images/gallery/img4.jpg')); ?>" alt="صورة ٤">
          <div class="img-label">Adobe Firefly</div>
        </div>
        <div class="img-card img-sm">
          <img src="<?php echo e(asset('images/gallery/img5.jpg')); ?>" alt="صورة ٥">
    ...
    <div class="section-inner">
      ...
      <div class="examples-grid">
        <div class="example-card reveal">
          <div class="vid-thumb">
            <video poster="<?php echo e(asset('videos/thumb1.jpg')); ?>" controls preload="metadata">
              <source src="<?php echo e(asset('videos/example1.mp4')); ?>" type="video/mp4">
            </video>
        ...
        <div class="example-card reveal" style="transition-delay:.08s">
          <div class="vid-thumb">
            <video poster="<?php echo e(asset('videos/thumb2.jpg')); ?>" controls preload="metadata">
              <source src="<?php echo e(asset('videos/example2.mp4')); ?>" type="video/mp4">
            </video>
        ...
        <div class="example-card reveal" style="transition-delay:.16s">
          <div class="vid-thumb">
            <video poster="<?php echo e(asset('videos/thumb3.jpg')); ?>" controls preload="metadata">
              <source src="<?php echo e(asset('videos/example3.mp4')); ?>" type="video/mp4">
            </video>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\AdhOom\laravel\generative-ai\resources\views/index.blade.php ENDPATH**/ ?>