...
<?php $__env->startSection('title', 'أمثلة حية | نظم الوسائط المتعددة'); ?>
            ...
            <div class="featured-video reveal" style="transition-delay:.08s">
                ...
                <div class="vid-placeholder">
                    <video width="100%" height="100%" style="object-fit:cover; position:absolute; top:0; left:0;" controls>
                        <source src="<?php echo e(asset('videos/featured.mp4')); ?>" type="video/mp4">
            ...
            <div class="video-grid">
                ...
                <div class="vid-card vc-violet reveal">
                    <div class="vc-thumb thumb-bg-v">
                        <video width="100%" height="100%" style="object-fit:cover; position:absolute; top:0; left:0;" controls>
                            <source src="<?php echo e(asset('videos/diffusion_intro.mp4')); ?>" type="video/mp4">
                        </video>
                ...
                <div class="vid-card vc-pink reveal" style="transition-delay:.07s">
                    <div class="vc-thumb thumb-bg-p">
                        <video width="100%" height="100%" style="object-fit:cover; position:absolute; top:0; left:0;" controls>
                            <source src="<?php echo e(asset('videos/elevenlabs_voice.mp4')); ?>" type="video/mp4">
                        </video>
                ...
                <div class="vid-card vc-cyan reveal" style="transition-delay:.14s">
                    <div class="vc-thumb thumb-bg-c">
                        <video width="100%" height="100%" style="object-fit:cover; position:absolute; top:0; left:0;" controls>
                            <source src="<?php echo e(asset('videos/image_to_video.mp4')); ?>" type="video/mp4">
                        </video>
                ...
                <div class="vid-card vc-gold reveal" style="transition-delay:.21s">
                    <div class="vc-thumb thumb-bg-g">
                        <video width="100%" height="100%" style="object-fit:cover; position:absolute; top:0; left:0;" controls>
                            <source src="<?php echo e(asset('videos/suno_music.mp4')); ?>" type="video/mp4">
                        </video>
                ...
                <div class="vid-card vc-violet reveal" style="transition-delay:.28s">
                    <div class="vc-thumb thumb-bg-v">
                        <video width="100%" height="100%" style="object-fit:cover; position:absolute; top:0; left:0;" controls>
                            <source src="<?php echo e(asset('videos/workflow_midjourney_runway.mp4')); ?>" type="video/mp4">
                        </video>
                        <div class="play-circle pc-v"><svg viewBox="0 0 24 24" class="svg-v"><path d="M8 5v14l11-7z"/></svg></div>
                ...
                <div class="vid-card vc-pink reveal" style="transition-delay:.35s">
                    <div class="vc-thumb thumb-bg-p">
                        <video width="100%" height="100%" style="object-fit:cover; position:absolute; top:0; left:0;" controls>
                            <source src="<?php echo e(asset('videos/firefly_editing.mp4')); ?>" type="video/mp4">
                        </video>
                        <div class="play-circle pc-p"><svg viewBox="0 0 24 24" class="svg-p"><path d="M8 5v14l11-7z"/></svg></div>
            ...
            <div class="audio-grid">
                ...
                <div class="audio-card ac-pink reveal">
                    ...
                    <div class="audio-player">
                        <audio id="audio1" src="<?php echo e(asset('audio/arabic_intro.mp3')); ?>" preload="metadata"></audio>
                ...
                <div class="audio-card ac-gold reveal" style="transition-delay:.08s">
                    ...
                    <div class="audio-player">
                        <audio id="audio2" src="<?php echo e(asset('audio/ambient_tech.mp3')); ?>" preload="metadata"></audio>
                ...
                <div class="audio-card reveal" style="transition-delay:.16s">
                    ...
                    <div class="audio-player">
                        <audio id="audio3" src="<?php echo e(asset('audio/sfx_transitions.mp3')); ?>" preload="metadata"></audio>
                ...
                <div class="audio-card reveal" style="transition-delay:.24s">
                    ...
                    <div class="audio-player">
                        <audio id="audio4" src="<?php echo e(asset('audio/gans_explanation.mp3')); ?>" preload="metadata"></audio>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\AdhOom\laravel\generative-ai\resources\views/examples.blade.php ENDPATH**/ ?>